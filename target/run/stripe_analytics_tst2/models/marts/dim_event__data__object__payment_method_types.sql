-- back compat for old kwarg name
    ...
    merge into `dlt-dev-external`.`stripe_tst_2_transformed`.`dim_event__data__object__payment_method_types` as DBT_INTERNAL_DEST
        using (/* Table: event__data__object__payment_method_types */
/* Parent: event */
