-- back compat for old kwarg name
    ...
    merge into `dlt-dev-external`.`stripe_tst_2_transformed`.`dim_invoice__lines__data__discount_amounts` as DBT_INTERNAL_DEST
        using (/* Table: invoice__lines__data__discount_amounts */
